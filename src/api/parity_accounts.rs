...
mod tests {
    ...
    rpc_test! (
        ...
        Value::String("0x4C8aB9d3e938285776d6717d7319F6a9B1d809DD".into()) => Address::from("0x4C8aB9d3e938285776d6717d7319F6a9B1d809DD")
    );

    rpc_test! (
        ParityAccounts :   parity_remove_address,  &Address::from("0x9b776baeaf3896657a9ba0db5564623b3e0173e0")
